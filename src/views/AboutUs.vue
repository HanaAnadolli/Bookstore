<template>
         ...
         <div class="row">
            <div class="col-lg-6 col-xl-5">
                 <div class="text-container">
                     <h1 class="h1-large"> Get more info about page</h1>
             ...
             <div class="col-lg-6 col-xl-7">
                 <div class="image-container" style="width:100%">
                     <img class="img-fluid" :src="require('@/assets/images/header-image.png')" alt="alternative" />
                 </div> 
             </div> 
         </div> 
     </div> 
   ...
   <div class="cards-2 bg-gray">
     <div class="container">
         <div class="row">
             <div class="col-lg-12">
                 <h2 class="h2-heading">Customer feedbacks about books </h2>
             </div> 
         </div>
         <div class="row">
             <div class="col-lg-12">
   ...
   <div class="basic-3">
     <div class="container">
         <div class="row">
             <div class="col-lg-12">
                 <div class="text-container">
                     <h2>Write about your favorite book</h2>
                     ...
                     <a class="btn-solid-lg" href="#contact">Click here</a>
                 </div> 
             </div> 
         </div>
     </div> 
         ...
         <div class="row">
             <div class="col-lg-6">
                 <div class="text-container">
                     ...
                     <h2>Tell us more about ur preferences</h2>
             ...
             <div class="col-lg-6">
                 ...
                 <form @submit.prevent="handleSubmitForm">
                     ...
                     <div class="form-group">
                         <input  type ="text" v-model="favoritebook.name" class="form-control-input" placeholder="Name" required />
                     </div>
                     <div class="form-group">
                         <input type="email" v-model="favoritebook.email" class="form-control-input" placeholder="Email" required />
                     </div>
                     <div class="form-group">
                         <input type="text" v-model="favoritebook.book" class ="form-control-input" placeholder="Book" required />
                     </div>
                     <div class="form-group">
                         <input type="text" v-model="favoritebook.description" class ="form-control-input" placeholder="Your description" required />
                     </div>
                     <div class="form-group">
...
export default {
  ...
  methods: {
    handleSubmitForm() {
      let apiURL = "http://localhost:4000/apiF/create-favoritebook";
      axios
        .post(apiURL, this.favoritebook)
        .then(() => {
...
.btn-solid-reg:hover {
	...
	color: #B6594C; /* needs to stay here because of the color property of a tag */
	text-decoration: none;
}
...
.cards-2 .card .gradient-floor.red-to-blue {
	background: linear-gradient(to right,  #B6594C, #3b704a);
}
